...
class LeJEPACaptioner(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            llm_dim: LLM embedding dimension (1024 for Gemma3)
    ...
    def forward(
        ...
        vision_tokens = self.connector(patch_embeds)  # (B, 49, 1024)
        
        # Predict text embeddings
        text_embeds = self.predictor(vision_tokens, num_tokens)  # (B, N, 1024)
...
if __name__ == "__main__":
    ...
    assert vis.shape == (2, 49, 1024), f"Expected (2, 49, 1024), got {vis.shape}"
